...
export default function ReportsPage() {
  ...
  return (
    <ProtectedRoute>
      <div className="space-y-8 max-w-7xl mx-auto pb-16 print:space-y-0 print:pb-0 print:m-0 print:max-w-none">
        {/* Page Top Header (Screen Only) */}
        <div className="print-hide print:hidden flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 border-b border-border/60">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              {isEs
                ? "Configura el período exacto y módulos a certificar para exportar o imprimir en PDF oficial."
                : "Configure your date range and certified modules to print or export as an official PDF."}
            </p>
          </div>
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            <button
              onClick={handlePrint}
              disabled={loading}
              className="flex items-center justify-center gap-2 px-4 sm:px-5 h-10 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 hover:from-blue-700 hover:to-indigo-700 text-white font-bold text-xs sm:text-sm shadow-md shadow-blue-500/25 hover:shadow-lg hover:shadow-blue-500/35 transition-all cursor-pointer active:scale-95 disabled:opacity-50"
            >
              <Printer size={16} />
              <span>{isEs ? "Imprimir / Guardar en PDF" : "Print / Save as PDF"}</span>
            </button>
          </div>
        </div>
        ...
        {!loading && (
          <div className="print-hide print:hidden p-5 sm:p-6 rounded-2xl bg-card border border-border/80 shadow-xs space-y-4">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
              ...
              <Popover open={isCalendarOpen} onOpenChange={setIsCalendarOpen}>
                <PopoverTrigger asChild>
                  <button
                    type="button"
                    className={`flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-semibold border transition cursor-pointer self-start lg:self-auto ${
                      preset === "custom"
                ...
                <PopoverContent
                  align="end"
                  sideOffset={8}
                  className="w-auto p-4 bg-popover text-popover-foreground border-border shadow-2xl rounded-2xl z-[300]"
                >
            ...
            <div className="pt-3 border-t border-border/50 flex flex-wrap items-center justify-between gap-4 text-xs font-mono">
              <div className="flex flex-wrap items-center gap-4 text-muted-foreground">
                <span>
                  {isEs ? "Ingresos filtrados:" : "Filtered income:"}{" "}
                ...
                <span>•</span>
                <span>
                  {isEs ? "Egresos filtrados:" : "Filtered expenses:"}{" "}
        ...
        <div className="rounded-2xl bg-slate-200/60 dark:bg-slate-950/60 p-4 sm:p-10 flex justify-center border border-border/60 shadow-inner print:p-0 print:m-0 print:bg-transparent print:border-none print:shadow-none print:rounded-none print:block">
          {/* Printable Official Financial Document */}
          <div
            id="printable-financial-report"
            className="w-full max-w-[850px] bg-white text-slate-900 border border-slate-300/80 shadow-2xl rounded-sm p-8 sm:p-12 font-sans text-sm leading-normal transition-all print:p-0 print:m-0 print:max-w-none print:border-none print:shadow-none print:rounded-none print:w-full"
          >
            {/* Header: Corporate Branding & Technical Audit Box */}
            <div className="report-section pb-6 border-b-2 border-slate-400 mb-6">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
                ...
                <div className="sm:text-right border border-slate-300 bg-slate-50 p-3 rounded-lg text-xs space-y-1 shrink-0 font-mono">
                  ...
                  <div className="text-[10px] font-semibold text-blue-800 bg-blue-100/70 border border-blue-200 px-2 py-0.5 rounded inline-block">
              ...
              <div className="mt-6 pt-4 border-t border-slate-200 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 text-xs">
                <div>
